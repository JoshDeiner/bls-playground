def map_bls_data_with_ids(response):
    ...
    series_entry = {
        ...
        'catalog_title': response['data']['Results']['series'][0]['catalog']['series_title'],
        'seasonality': response['data']['Results']['series'][0]['catalog']['seasonality'],
        'survey_name': response['data']['Results']['series'][0]['catalog']['survey_name'],
        'measure_data_type': response['data']['Results']['series'][0]['catalog']['measure_data_type'],
    ...
    for idx, data_point in enumerate(response['data']['Results']['series'][0]['data']):
        ...
        series_data_entry = {
            ...
            'footnotes': data_point.get('footnotes', [{}])  # Defaults to empty if missing
        }
